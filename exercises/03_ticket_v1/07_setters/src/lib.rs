...
impl Ticket {
    fn validated_title(title: String) -> String {
        if title.is_empty() {
    ...
    fn valaidated_description(description: String) -> String {
    ...
    fn validated_status(status: String) -> String {
    ...
    pub fn new(title: String, description: String, status: String) -> Ticket {
        Ticket {
            title: Ticket::validated_title(title),
            description: Ticket::valaidated_description(description),
            status: Ticket::validated_status(status),
        }
    }
    ...
    pub fn set_title(&mut self, title: String) {
        self.title = Ticket::validated_title(title);
    }
    ...
    pub fn set_description(&mut self, description: String) {
        self.description = Ticket::valaidated_description(description);
    }
    ...
    pub fn set_status(&mut self, status: String) {
        self.status = Ticket::validated_status(status);
    }
}
